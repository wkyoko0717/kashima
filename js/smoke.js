...
const animate = () => {
    ...
    lights = () => {
        // const light = new THREE.DirectionalLight(0x77c1d1, 0.5);
        const light = new THREE.DirectionalLight(0xbedaed, 0.8);
        // const light = new THREE.DirectionalLight(0x0000CB, 1);

        clock = new THREE.Clock();

        renderer = new THREE.WebGLRenderer();
        // renderer.setClearColor(0x00547f, 1);
        // renderer.setClearColor(0x6c90a8, 1);
